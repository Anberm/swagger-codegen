...
public class EmesAngularClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public EmesAngularClientCodegen() {
        super();
        this.outputFolder = "generated-code/emes-angular";

        embeddedTemplateDir = templateDir = "emes-angular";
    ...
    public String getHelp() {
        return "Generates a Emes Angular client library.";
    }
